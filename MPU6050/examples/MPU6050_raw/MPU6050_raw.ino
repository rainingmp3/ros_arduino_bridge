...
void loop() {
  ...
  // needs to be adjusted depending on a sampling range (e.g. +- 2g, +-250 degrees,
  // which are defaults, that are used below)
  ...
  gx_f = gx * 0.0001332312     ;// value / 131 * 0.01745329: LSB/degree/s -> degree/s -> radian/s 
  gy_f = gy * 0.0001332312     ;// value / 131 * 0.01745329: LSB/degree/s -> degree/s -> radian/s 
  gz_f = gz * 0.0001332312     ;// value / 131 * 0.01745329: LSB/degree/s -> degree/s -> radian/s 
